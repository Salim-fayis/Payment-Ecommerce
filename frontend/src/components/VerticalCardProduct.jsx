            ...
            <div className='flex items-center gap-4 md:gap-6  overflow-x-scroll scrollbar-none transition-all' ref={scrollElement}>
                ...
                </button>
                {
                    ...
                    <div className='w-full min-w-[280px]  md:min-w-[320px] max-w-[280px] md:max-w-[320px]  bg-white rounded-sm shadow'>
                        ...
                        <div className='p-4 grid gap-2  truncating'>
                            ...
                            <div className='flex gap-3'>
                                <p className='text-slate-500 py-2 line-through p-1 animate-pulse rounded-full bg-slate-200 w-full'></p>
    
                                <p className='text-red-600 font-medium py-2 p-1 animate-pulse rounded-full bg-slate-200 w-full'></p>
                            </div>
                            ...
                            return (
                                <Link to={"product/" + product?._id} className='w-full min-w-[280px]  md:min-w-[320px] max-w-[280px] md:max-w-[320px]  bg-white rounded-sm shadow'>
                                    ...
                                    <div className='p-4 grid gap-2  '>
                                        <h2 className='capitalize font-medium text-base md:text-lg text-black text-ellipsis line-clamp-1'>{product.productName}</h2>
