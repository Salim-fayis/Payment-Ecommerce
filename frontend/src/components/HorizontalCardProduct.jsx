                ...
                </button>
                {
                    loading ? (
                            ...
                            return (
                                <div className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex'>
                                    ...
                                    <div className='p-4 grid w-full gap-2 '>
                                        <h2 className='font-medium text-base md:text-lg text-black bg-slate-200 animate-pulse p-1 rounded-full'></h2>
                                        ...
                                        <button className='text-sm  text-white px-3 py-1 rounded-full w-full bg-slate-200 animate-pulse p-1 '></button>
                                    </div>
                        ...
                        data.map((product, index) => {
                            return (
                                <Link to={"product/" + product?._id} className='w-full min-w-[280px] md:min-w-[350px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex overflow-hidden'>
                                    <div className='bg-slate-200 h-full p-4 min-w-[120px] md:min-w-[145px] '>
                                        <img src={product.productImage[0]} className='object-scale-down  h-full hover:scale-110 transition-all mix-blend-multiply' />
                                    </div>
                                    <div className='p-4 grid  '>
                                        <h2 className='capitalize font-medium text-base md:text-lg truncate text-black'>{product.productName}</h2>
